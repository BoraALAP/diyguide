    ...
    try {
        ...
        const aiResponse = await openai.beta.chat.completions.parse({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are a specialist on writing a do it your self guides. You are given a topic and you need to write a detailed guide for it. You need to provide steps and tips. also generate a list of materials and tools needed. additionally, give tags for the guide."
                },
                {
                    role: "user",
                    content: query
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(query);
    } catch (error) {
